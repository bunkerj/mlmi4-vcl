...
trainer = VariationalTrainer(dictParams)
accuracy = trainer.train()
filename = "exp_3/SN_VCL_RC_160.p"
pickle.dump(accuracy, open(filename, "wb"))
...
trainer = VariationalTrainer(dictParams)
accuracy = trainer.train()
filename = "exp_3/SN_VCL_KC_160.p"
pickle.dump(accuracy, open(filename, "wb"))
...
trainer = VariationalTrainer(dictParams)
accuracy = trainer.train()
filename = "exp_3/SN_VCL_RC_320.p"
pickle.dump(accuracy, open(filename, "wb"))
...
trainer = VariationalTrainer(dictParams)
accuracy = trainer.train()
filename = "exp_3/SN_VCL_KC_320.p"
pickle.dump(accuracy, open(filename, "wb"))
